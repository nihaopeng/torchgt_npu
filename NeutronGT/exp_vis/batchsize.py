...
if __name__ == "__main__":
        ...
        'axes_params' : [
            {
                'y_val' : {
                    'TorchGT': [1, 1, 1, 1],
                    'UnifiedGT': [0.761441022, 1.092066053, 1.580794138, 2.589277504],
                    'NeutronGT':[8.512820513, 9.613412229, 12.08481262, 16.66074951],
                },
                'x_ticks' : ['16k','32k','64k','128k'],
                'title' : '(a) OAV',
                'y1_lim' : (0.5, 32),
                # 'y2_lim' : (1e-5, 10),
                'y1_log' : True,
            ...
            },
            {
                'y_val' : {
                    'TorchGT': [1, 1, 1, 1],
                    'UnifiedGT':[3.95606697, 5.754029134, 11.5574077, 20.89466051],
                    'NeutronGT':[60.30469817, 66.29697726, 102.3085882, 187.3899652],
                },
                'x_ticks' : ['16k','32k','64k','128k'],
                'title' : '(b) RDT',
                'y1_lim' : (0.5, 256),
    ...
    parallel_bar(params, my_params, figpath='batch_size.pdf')
