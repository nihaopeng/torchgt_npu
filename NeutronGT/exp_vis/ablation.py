        ...
        'axes_params' : [
            {
                'y_val' : {
                    'Baseline': [1, 1, 1, 1, 1],
                    'Baseline+HAW': [1.670451059, 35.75071297, 14.71996592, 11.42793054, 11.4494786],
                    'Baseline+HAW+IWP' : [16.28964692,313.6356255,295.6288243,59.89626556, 679.8240702],
                },
                'x_ticks' : ['OAV','AZ','OPT','RDT',"OPR"],
                'title' : '',
                'y1_lim' : (0.01, 1000),
                # 'y2_lim' : (1e-5, 10),
                'y1_log' : True,
